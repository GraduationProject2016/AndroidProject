...
public class CommandConstant {
	...
	public static final String getAndroidDeviceInfo = "getAndroidDeviceInfo";

	public static final String androidPathJson = "androidPath";

	public static final String androidHomeJson = "androidHome";
